...
public class BoundingBoxCuboid extends BoundingBoxBase {
    ...
    public static final BoundingBoxId id = BoundingBoxId.getBoundingBoxIdInstance("BoundingBoxCuboid");
    ...
    public void updatePos() {
        ...
        */
        BigDecimal xc = new BigDecimal(this.width * this.rotationY.cos() * this.rotationZ.cos(), CraftWorld.divideMc);
        BigDecimal yc = new BigDecimal(this.length * this.rotationX.cos() * this.rotationZ.cos(), CraftWorld.divideMc);
        BigDecimal zc = new BigDecimal(this.height * this.rotationX.cos() * this.rotationY.cos(), CraftWorld.divideMc);
        BigDecimal xs = new BigDecimal(this.width * this.rotationY.sin() * this.rotationZ.sin(), CraftWorld.divideMc);
        BigDecimal ys = new BigDecimal(this.length * this.rotationX.sin() * this.rotationZ.sin(), CraftWorld.divideMc);
        BigDecimal zs = new BigDecimal(this.height * this.rotationX.sin() * this.rotationY.sin(), CraftWorld.divideMc);
        this.brd.setFullX(this.bld.getFullX().add(xc));
        this.brd.setFullY(this.bld.getFullY());
        this.brd.setFullZ(this.bld.getFullZ());
        this.fld.setFullX(this.bld.getFullX());
        this.fld.setFullY(this.bld.getFullY().add(yc));
        this.fld.setFullZ(this.bld.getFullZ());
        this.blu.setFullX(this.bld.getFullX());
        this.blu.setFullY(this.bld.getFullY());
        this.blu.setFullZ(this.bld.getFullZ().add(zc));
        this.frd.setFullX(this.brd.getFullX());
        this.frd.setFullY(this.brd.getFullY().add(yc));
        this.frd.setFullZ(this.brd.getFullZ());
        this.bru.setFullX(this.blu.getFullX().add(xc));
        ...
        this.flu.setFullZ(this.fld.getFullZ().add(zc));
        this.fru.setFullX(this.frd.getFullX());
        this.fru.setFullY(this.frd.getFullY());
        this.fru.setFullZ(this.frd.getFullZ().add(zc));
