...
public class AdditionsLoaderTest {
    @Test
    public void load() throws IOException, NoSuchFieldException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        ((Map<String, Addition>) field.get(null)).put("FantasyWorld", (Addition) constructor.newInstance());
