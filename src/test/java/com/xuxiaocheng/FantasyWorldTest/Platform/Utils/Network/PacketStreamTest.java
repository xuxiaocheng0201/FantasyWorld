...
public class PacketStreamTest {
    ...
    protected static final Float[] floatsTest = new Float[] {0.0F, 0.1F, 1.0F, 1.0e-5F, 2147483647.0F, -1.0F, -65536.0F, -2147483648.0F, Float.MIN_VALUE, Float.MIN_VALUE + 1, Float.MAX_VALUE, Float.MAX_VALUE - 1};
    protected static final Double[] doublesTest = new Double[] {0.0, 0.1, 1.0, 1.0e-5, 2147483647.0, -1.0, -65536.0, -2147483648.0, Double.MIN_VALUE, Double.MIN_VALUE + 1, Double.MAX_VALUE, Double.MAX_VALUE - 1};
    protected static final String[] stringsTest = new String[] {null, "", "Hello", "中文测试"};
    ...
    protected static <T> void checkIO(final T @NotNull [] tests, final int off, final @NotNull Supplier<? extends T> randomer, final @NotNull Method writer, final @NotNull Method reader) throws IOException, InvocationTargetException, IllegalAccessException {
